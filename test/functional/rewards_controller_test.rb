...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { child_id: @reward.child_id, costs: @reward.costs, image: @reward.image, name: @reward.name, rewarded: @reward.rewarded }
    end
  ...
  test "should update reward" do
    put :update, id: @reward, reward: { child_id: @reward.child_id, costs: @reward.costs, image: @reward.image, name: @reward.name, rewarded: @reward.rewarded }
    assert_redirected_to reward_path(assigns(:reward))
  end
